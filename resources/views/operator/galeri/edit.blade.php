    ...
    <div class="row justify-content-center">
        <div class="col-lg-6">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('operator.galeri.update', $galeri->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            <div class="text-center">
                                ...
                                <img src="{{ asset('storage/' . $galeri->gambar) }}" alt="{{ $galeri->judul }}" class="img-fluid rounded" style="max-height: 300px;">
                            </div>
                        </div>
