                ...
                <div class="card-body">
                    <form action="{{ route('operator.galeri.update', Crypt::encrypt($galeri->id_galeri)) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="file" class="form-label">File Media Baru</label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                           id="tanggal" name="tanggal" value="{{ old('tanggal', $galeri->tanggal->format('Y-m-d')) }}" required>
                                    @error('tanggal')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            <div class="text-center">
                                ...
                                @if($galeri->kategori == 'Foto')
                                    <img src="{{ $galeri->fileUrl }}" alt="{{ $galeri->judul }}" class="img-fluid rounded" style="max-height: 300px;">
                                @else
                                    <video controls class="img-fluid rounded" style="max-height: 300px;">
                                        <source src="{{ $galeri->fileUrl }}" type="video/mp4">
