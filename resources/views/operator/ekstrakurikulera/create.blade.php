    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{{ route('operator.ekstrakurikulera.index') }}" class="btn btn-secondary btn-sm">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('operator.ekstrakurikulera.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('operator.ekstrakurikulera.index') }}" class="btn btn-secondary">
