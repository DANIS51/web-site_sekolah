    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2>Edit Berita</h2>
                <a href="{{ route('operator.berita.index') }}" class="btn btn-secondary btn-sm">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('operator.berita.update', $berita->id_berita) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="isi" class="form-label">Konten Berita <span class="text-danger">*</span></label>
                            <textarea class="form-control @error('isi') is-invalid @enderror"
                                      id="isi" name="isi" rows="10" required>{{ old('isi', $berita->isi) }}</textarea>
                            @error('isi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">Tulis konten berita dengan lengkap dan informatif</div>
                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    @if($berita->gambar)
                                        <div class="mt-2">
                                            ...
                                            <img src="{{ asset('storage/' . $berita->gambar) }}" alt="Gambar Berita" width="200" height="150" class="rounded">
                                        </div>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('operator.berita.index') }}" class="btn btn-secondary">
