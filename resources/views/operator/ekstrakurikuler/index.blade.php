        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="{{ route('operator.ekstrakurikuler.create') }}" class="btn btn-primary">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route('operator.ekstrakurikuler.edit', Crypt::encrypt($item->id_ekskul)) }}" class="btn btn-warning btn-sm me-2">
                                                        <i class="bi bi-pencil-square me-2"></i> Edit
                                                    </a>
                                                    <form
                                                        action="{{ route('operator.ekstrakurikuler.destroy', Crypt::encrypt($item->id_ekskul)) }}"
