...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            ...
            <p class="text-muted">Selamat datang di sistem manajemen sekolah. Kelola data siswa, berita, galeri, ekstrakurikuler, dan profil sekolah.</p>
        </div>
    </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            <a href="{{ route('operator.ekstrakurikulera.create') }}" class="btn btn-warning btn-sm btn-block">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="list-group list-group-flush">
                        ...
                        <a href="{{ route('operator.ekstrakurikulera.index') }}" class="list-group-item list-group-item-action">
                            <i class="bi bi-trophy me-2"></i> Kelola Ekstrakurikuler
                        </a>
                        <a href="{{ route('operator.profil_sekolah.index') }}" class="list-group-item list-group-item-action">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted small">
                        Sebagai operator, Anda dapat mengelola data siswa, berita, galeri, ekstrakurikuler, dan profil sekolah.
