    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2>Ubah Password</h2>
                <a href="{{ route('operator.profile') }}" class="btn btn-secondary btn-sm">
                    <i class="bi bi-arrow-left me-1"></i> Kembali ke Profile
                </a>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <form action="{{ route('operator.profile.password.update') }}" method="POST">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('operator.profile') }}" class="btn btn-secondary">
