...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            ...
            <p class="text-muted">Selamat datang di sistem manajemen sekolah. Kelola data siswa, guru, berita, galeri, ekstrakurikuler, dan user.</p>
        </div>
    </div>
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="list-group list-group-flush">
                        ...
                        <a href="{{ route('admin.guru') }}" class="list-group-item list-group-item-action">
                            <i class="bi bi-person-badge me-2"></i> Kelola Data Guru
                        </a>
                        <a href="{{ route('admin.berita') }}" class="list-group-item list-group-item-action">
