    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{{ route('admin.profil_sekolah.create') }}" class="btn btn-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="{{ route('admin.profil_sekolah.edit', $profil->id_profil) }}" class="btn btn-warning btn-sm me-2">
                                                    <i class="bi bi-pencil-square me-2"></i> Edit
                                                </a>
                                                <form action="{{ route('admin.profil_sekolah.destroy', $profil->id_profil) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus profil sekolah ini?')">
                                                    @csrf
                                                    @method('DELETE')
