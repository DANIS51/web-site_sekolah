...
@section('content')
                ...
                <div class="row align-items-center">
                    <div class="col-md-4 text-center mb-3">
                        @if($profilSekolah->logo_url)
                            <img src="{{ $profilSekolah->logo_url }}" alt="Logo Sekolah" class="img-fluid mb-3" style="max-height:120px;">
                        @endif
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm">
                        @if($beritaItem->gambar)
                            <img src="{{ asset('storage/' . $beritaItem->gambar) }}" class="card-img-top" alt="{{ $beritaItem->judul }}">
                        @endif
                        <div class="card-body">
                            ...
                            <a href="{{ route('public.berita.show', $beritaItem->id_berita) }}" class="btn btn-outline-primary btn-sm">
                                Baca Selengkapnya
                            </a>
                        </div>
                    </div>
    ...
    <section class="py-5 bg-light">
        <div class="container" data-aos="fade-up" data-aos-duration="1000">
            <h2 class="text-center text-primary fw-bold mb-4"><i class="fas fa-th-large me-2"></i> Akses Cepat</h2>
            <div class="row text-center">
                <div class="col-6 col-md-2 mb-3">
                    <a href="{{ route('public.guru') }}" class="d-block p-3 bg-primary text-white rounded shadow-sm text-decoration-none">
                        <i class="fas fa-chalkboard-teacher fa-2x mb-2"></i><div>Guru</div>
                    </a>
                </div>
                <div class="col-6 col-md-2 mb-3">
                    <a href="{{ route('public.siswa') }}" class="d-block p-3 bg-success text-white rounded shadow-sm text-decoration-none">
                        <i class="fas fa-users fa-2x mb-2"></i><div>Siswa</div>
                    </a>
                </div>
                <div class="col-6 col-md-2 mb-3">
                    <a href="{{ route('public.galeri') }}" class="d-block p-3 bg-info text-white rounded shadow-sm text-decoration-none">
                        <i class="fas fa-images fa-2x mb-2"></i><div>Galeri</div>
                    </a>
                </div>
                <div class="col-6 col-md-2 mb-3">
                    <a href="{{ route('public.ekstrakurikuler') }}" class="d-block p-3 bg-warning text-white rounded shadow-sm text-decoration-none">
                        <i class="fas fa-trophy fa-2x mb-2"></i><div>Ekstrakurikuler</div>
                    </a>
                </div>
                <div class="col-6 col-md-2 mb-3">
                    <a href="{{ route('public.berita') }}" class="d-block p-3 bg-danger text-white rounded shadow-sm text-decoration-none">
                        <i class="fas fa-newspaper fa-2x mb-2"></i><div>Berita</div>
                    </a>
                </div>
                <div class="col-6 col-md-2 mb-3">
                    <a href="{{ route('public.profil-sekolah') }}" class="d-block p-3 bg-dark text-white rounded shadow-sm text-decoration-none">
                        <i class="fas fa-info-circle fa-2x mb-2"></i><div>Profil</div>
                    </a>
                </div>
            </div>
        </div>
