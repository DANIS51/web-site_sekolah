                ...
                <div class="row">
                    <div class="col-md-6">
                        @if($profilSekolah->logo_url)
                            <img src="{{ $profilSekolah->logo_url }}" alt="Logo Sekolah" class="img-fluid mb-3" style="max-height: 150px;">
                        @endif
                ...
                <div class="row">
                    <div class="col-md-2 col-sm-4 col-6 mb-3">
                        <a href="{{ route('public.guru') }}" class="text-decoration-none">
                            <div class="text-center p-3" style="background: linear-gradient(135deg, #6f42c1, #e83e8c); color: white; border-radius: 10px;">
                    ...
                    <div class="col-md-2 col-sm-4 col-6 mb-3">
                        <a href="{{ route('public.siswa') }}" class="text-decoration-none">
                            <div class="text-center p-3" style="background: linear-gradient(135deg, #28a745, #20c997); color: white; border-radius: 10px;">
                    ...
                    <div class="col-md-2 col-sm-4 col-6 mb-3">
                        <a href="{{ route('public.galeri') }}" class="text-decoration-none">
                            <div class="text-center p-3" style="background: linear-gradient(135deg, #17a2b8, #6f42c1); color: white; border-radius: 10px;">
                    ...
                    <div class="col-md-2 col-sm-4 col-6 mb-3">
                        <a href="{{ route('public.ekstrakurikuler') }}" class="text-decoration-none">
                            <div class="text-center p-3" style="background: linear-gradient(135deg, #ffc107, #fd7e14); color: white; border-radius: 10px;">
                    ...
                    <div class="col-md-2 col-sm-4 col-6 mb-3">
                        <a href="{{ route('public.berita') }}" class="text-decoration-none">
                            <div class="text-center p-3" style="background: linear-gradient(135deg, #dc3545, #e83e8c); color: white; border-radius: 10px;">
                    ...
                    <div class="col-md-2 col-sm-4 col-6 mb-3">
                        <a href="{{ route('public.profil-sekolah') }}" class="text-decoration-none">
                            <div class="text-center p-3" style="background: linear-gradient(135deg, #6c757d, #495057); color: white; border-radius: 10px;">
